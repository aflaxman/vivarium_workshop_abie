...
all necessary requirements as follows::
  ...
  :~$ conda create --name=vivarium_workshop_abie python=3.11 git git-lfs
  ...conda will download python and base dependencies...
  :~$ conda activate vivarium_workshop_abie
  (vivarium_workshop_abie) :~$ git clone https://github.com/ihmeuw/vivarium_workshop_abie.git
  ...git will copy the repository from github and place it in your current directory...
  (vivarium_workshop_abie) :~$ cd vivarium_workshop_abie
  (vivarium_workshop_abie) :~$ pip install -e .
...
`pip install -e .` with the following::
  ...
  (vivarium_workshop_abie) :~$ pip install -r requirements.txt
...
install hdf tooling from within your environment like so::
  ...
  (vivarium_workshop_abie) :~$ conda install hdf5

The ``(vivarium_workshop_abie)`` that precedes your shell prompt will probably show
...
``src/vivarium_workshop_abie`` package directory:
...
- ``components``
  ...
  the vivarium_workshop_abie project. You should work with the
...
With this model specification file and your conda environment active, you can then run simulations by, e.g.::
   ...
   (vivarium_workshop_abie) :~$ simulate run -v /<REPO_INSTALLATION_DIRECTORY>/vivarium_workshop_abie/src/vivarium_workshop_abie/model_specifications/model_spec.yaml
